      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-2xl p-6 w-full max-w-lg mx-auto shadow-xl"
          >
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Clean Up Read Notifications</h3>
                <p className="text-sm text-gray-600">Permanently delete notifications that everyone has seen</p>
              </div>
            </div>
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="text-sm font-medium text-blue-900">What does this do?</h4>
            ...
            {systemHealth && (
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-gray-700">Current System Health</span>
            ...
            {adminSummary && (
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="bg-green-50 p-3 rounded-lg text-center">
                  ...
                  <div className="text-xs text-green-600">Will be deleted</div>
                </div>
                <div className="bg-blue-50 p-3 rounded-lg text-center">
                  ...
                  <div className="text-xs text-blue-600">Will remain</div>
                </div>
              </div>
            )}
